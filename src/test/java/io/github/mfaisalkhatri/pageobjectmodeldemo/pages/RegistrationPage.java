...
public class RegistrationPage {
    ...
    private final By            pageHeader          = By.cssSelector ("mat-card h1");
    ...
    public void registerNewUser (final RegistrationData registrationData) {
        ...
        final WebElement registerButton = this.driver.findElement (this.register);
    ...
    private void selectSecurityQuestion (final String questionText) {
        this.driver.findElement (this.securityQuestions)
            .click ();
        final List<WebElement> questionsList = this.driver.findElements (this.questions);
        boolean found = false;
